...
def main():
    ...
    structures_dict = [
        ...
        {'name': 'Inlet Wing Wall East', 'abr': 'IE'},
        {'name': 'Inlet Wing Wall West', 'abr': 'IW'},
        {'name': 'Outlet Wing Wall East', 'abr': 'OE'},
        {'name': 'Outlet Wing Wall West', 'abr': 'OW'},
        {'name': 'Trifurcation 1', 'abr': 'TRF1'},
        {'name': 'Trifurcation 2', 'abr': 'TRF2'},
        {'name': 'Trifurcation 3', 'abr': 'TRF3'},
        {'name': 'Trifurcation 4', 'abr': 'TRF4'},
        {'name': 'Trifurcation 5', 'abr': 'TRF5'},
        {'name': 'Trifurcation 6', 'abr': 'TRF6'},
        {'name': 'PT Conduit 1', 'abr': 'T1'},
        {'name': 'PT Conduit 2', 'abr': 'T2'},
        {'name': 'PT Conduit 3', 'abr': 'T3'},
        {'name': 'PT Conduit 4', 'abr': 'T4'},
        {'name': 'PT Conduit 5', 'abr': 'T5'},
        {'name': 'PT Conduit 6', 'abr': 'T6'},
        {'name': 'Valve Structure 1', 'abr': 'VS1'},
        {'name': 'Valve Structure 2', 'abr': 'VS2'},
        {'name': 'Valve Structure 3', 'abr': 'VS3'},
